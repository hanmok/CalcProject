...
//  Calie
//
//  Created by Mac mini on 2022/05/09.
...
class MyAlert {
    ...
    private var myTargetView: UIView?
     ...
     func showAlert(with title: String, message: String, on viewController: UIViewController) {
         ...
         // change backgroundView's frame to bounds to see diff
         // bounds: The bounds rectangle, which describes the view’s location and size in its own coordinate system.
         // frame: The frame rectangle, which describes the view’s location and size in its superview’s coordinate system. // relative
